...
static void task_download(task_t *t, task_t *tracker_task)
{
	...
	if (evil_mode)
		osp2p_writef(t->peer_fd, "\
...
* Try 'rm %s.~*~' to remove them.\n", t->filename, t->filename);
	...
	while (1) {
		...
		if (ret == TBUF_ERROR) {
			...
			/* End of file */
			break;
		//else if ((unsigned long) t->total_written > 1ul << 30) {
